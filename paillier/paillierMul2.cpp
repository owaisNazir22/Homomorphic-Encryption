...
cout<<"<style>input{ width: 40%; height: 10%; color: brown; border-radius: 60px; background: none; cursor: pointer; border: 2px solid #4caf50; color: white;}</style>"<<endl;
       ...
       cout << h2("D(E(m<sub>1</sub>,r<sub>1</sub>)<sup>m<sub>2</sub></sup> mod n<sup>2</sup>) = m<sub>1</sub>.m<sub>2</sub> mod n.");
...
mpz_powm(C,C2,C1,N_sqr);
        

     //Homomorphic addition
     cout << h4("E(m<sub>2</sub>,r<sub>1</sub>)<sup>m<sub>1</sub></sup> mod n<sup>2</sup>");
     ...
     cout << h4("D(E(m<sub>2</sub>,r<sub>1</sub>).<sup>m<sub>1</sub></sup> mod n<sup>2</sup>)");
