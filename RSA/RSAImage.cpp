...
// cout<<"<style>.fl{font: 10px; align: center;}</style>"<<endl;
...
cout << h2("The PGM format is used for image encrypt ,to encrypt the image it should be in the pgm.");
   ...
   cout << "<body>";
   cout << "<form    method = \"post\"  enctype = \"multipart/form-data\" action = \"/cgi-bin/RSA/RSAImageEncryption.cgi\" > File: <input type = \"file\" name = \"userfile\"> <div><input id = \"btn\" type = \"submit\" value = \"Upload\"></div>  </form> ";
    cout << "</body>\n";
   cout << "</html>\n";
